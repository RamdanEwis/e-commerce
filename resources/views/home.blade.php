...
@section('content')
    ...
    <section class="welcome_area">
        <div class="welcome_slides owl-carousel">
            <!-- Single Slide -->
            <div class="single_slide bg-img" style="background-image: url({{asset('web/img/bg-img/7.jpg')}});">
                    ...
                    <div class="row h-100 align-items-center">
                        ...
                        <div class="col-5 col-md-4">
                            <div class="welcome_slide_image">
                                <img src="{{asset('web/img/bg-img/slide-1.png')}}" alt="" data-animation="bounceInUp" data-delay="500ms">
...
--}}
            <!-- Single Slide -->
            <div class="single_slide bg-img" style="background-image: url({{asset('web/img/bg-img/6.jpg')}});">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4">
                    <div class="single_catagory_area mt-50">
                        <a href="#">
                            <img src="{{asset('web/img/bg-img/c1.jpg')}}" alt="">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="single_catagory_area mt-50">
                        <a href="#">
                            <img src="{{asset('web/img/bg-img/c2.jpg')}}" alt="">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="single_catagory_area mt-50">
                        <a href="#">
                            <img src="{{asset('web/img/bg-img/c3.jpg')}}" alt="">
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="popular_brands_slide owl-carousel">
                        <div class="single_brands">
                            <img src="{{asset('web/img/partner-img/1.jpg')}}" alt="">
                        </div>
                        <div class="single_brands">
                            <img src="{{asset('web/img/partner-img/2.jpg')}}" alt="">
                        </div>
                        <div class="single_brands">
                            <img src="{{asset('web/img/partner-img/3.jpg')}}" alt="">
                        </div>
                        <div class="single_brands">
                            <img src="{{asset('web/img/partner-img/4.jpg')}}" alt="">
                        </div>
                        <div class="single_brands">
                            <img src="{{asset('web/img/partner-img/5.jpg')}}" alt="">
                        </div>
                        <div class="single_brands">
                            <img src="{{asset('web/img/partner-img/6.jpg')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
