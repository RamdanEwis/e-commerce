        ...
        <div class="container">
            <div class="classy-nav-container breakpoint-off">
                <nav class="classy-navbar" id="bigshopNav">
                    ...
                    <!-- Nav Brand -->
                    <a href="index.html" class="nav-brand"><img src="{{asset('web/img/core-img/logo.png')}}" alt="logo"></a>
                                        ...
                                        <div class="single-mega cn-col-2">
                                            <div class="megamenu-slides owl-carousel">
                                                <a href="shop-grid-left-sidebar.html">
                                                    <img src="{{asset('web/img/bg-img/mega-slide-2.jpg')}}" alt="">
                                                </a>
                                                <a href="shop-list-left-sidebar.html">
                                                    <img src="{{asset('web/img/bg-img/mega-slide-1.jpg')}}" alt="">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="hero_meta_area ml-auto d-flex align-items-center justify-content-end">
                                ...
                                <ul class="cart-list">
                                    <li>
                                        <div class="cart-item-desc">
                                            <a href="#" class="image">
                                                <img src="{{asset('web/img/product-img/top-1.png')}}" class="cart-thumb" alt="">
                                            </a>
                                            <div>
                                    ...
                                    <li>
                                        <div class="cart-item-desc">
                                            <a href="#" class="image">
                                                <img src="{{asset('web/img/product-img/best-4.png')}}" class="cart-thumb" alt="">
                                            </a>
                                            <div>
                                                <a href="#">Headphone</a>
                        ...
                        <div class="account-area">
                            <div class="user-thumbnail">
                                <img src="{{asset('web/img/bg-img/user.jpg')}}" alt="">
                            </div>
                                 ...
                                 @auth()
                                     ...
                                     <li><a href="wishlist.html">Wishlist</a></li>
                                       <form id="form-logout" method="POST" action="{{route('logout')}}" style="display:none;">
                                         ...
                                         <li><a onclick="event.preventDefault(); document.getElementById('form-logout').submit();" href="{{route('logout')}}">logout</a></li>
